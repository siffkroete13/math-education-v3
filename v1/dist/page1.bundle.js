...
function _start() {
  _start = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var multiply_button, matrixSize, createMatrix, getMatrixValues, displayResult, multiplyMatrices;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          multiplyMatrices = function _multiplyMatrices(ev) {
            var A = getMatrixValues('matrixA');
            var B = getMatrixValues('matrixB');
            var result = [];
          ...
          displayResult = function _displayResult(matrix) {
            var table = document.getElementById('resultMatrix');
            table.innerHTML = ''; // Clear previous results
            var _iterator3 = _createForOfIteratorHelper(matrix),
              _step3;
            try {
          ...
          getMatrixValues = function _getMatrixValues(tableId) {
          ...
          createMatrix = function _createMatrix(tableId) {
            var table = document.getElementById(tableId);
            for (var i = 0; i < matrixSize; i++) {
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("page1." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
...
/******/ 	var __webpack_exports__ = __webpack_require__("./v1/src/page1.js");
/******/ 	
/******/ })()
;
